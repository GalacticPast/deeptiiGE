                                    ...
                                    vulkan_command_buffer *out_command_buffer)
{
    ...
    dzero_memory(out_command_buffer, sizeof(vulkan_command_buffer));
...
void vulkan_command_buffer_begin(vulkan_command_buffer *command_buffer, b8 is_single_use, b8 is_renderpass_continue,
