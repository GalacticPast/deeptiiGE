 ...
 * @return DAPI
 */
DAPI b8 filesystem_size(file_handle *handle, u64 *out_size);
 ...
 */
DAPI b8 filesystem_read_line(file_handle *handle, u64 max_length, char **line_buf, u64 *out_line_length);
 ...
 * @param out_bytes_read A pointer to a number which will be populated with the number of bytes actually read from the
 * file.
 * @returns True if successful; otherwise false.
 */
 ...
 * @returns True if successful; otherwise false.
 */
DAPI b8 filesystem_read_all_text(file_handle *handle, char *out_text, u64 *out_bytes_read);
 ...
 * @param out_bytes_written A pointer to a number which will be populated with the number of bytes actually written to
 * the file.
 * @returns True if successful; otherwise false.
 */
